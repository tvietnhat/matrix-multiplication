...
const vApp = new Vue({
    el: '#app',
    data: {
        matrix1: { rows: 7, cols: 10, cells: [], cellErrors: {}, isEditing: false },
        matrix2: { rows: 10, cols: 8, cells: [], cellErrors: {}, isEditing: false },
        result: null,
        resultInChars: null,
        errors: [],
        isMultiplying: false,
    ...
    methods: {
        ...
        cellValueChange: function(matrix, rIdx, cIdx) {
